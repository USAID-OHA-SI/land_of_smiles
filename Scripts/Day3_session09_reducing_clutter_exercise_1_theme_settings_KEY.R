# Exercise: Day3_session09_reducing_clutter_exercise_1_theme_settings_KEY
...
si #specified font, assign color, larger font size, left aligned, smaller margins
...
si_list$legend.position #legend placed at "top"
si_list$strip.placement #strip placed on "inside" 
